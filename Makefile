...
OBJS = src/pg_sorted_heap.o src/sorted_heap.o src/sorted_heap_scan.o src/sorted_heap_online.o src/sorted_vector_hash.o src/svec.o src/hsvec.o src/pq.o src/sorted_hnsw.o src/hnsw_build.o
