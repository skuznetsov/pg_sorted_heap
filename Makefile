...
OBJS = src/pg_sorted_heap.o src/sorted_heap.o src/sorted_heap_scan.o src/sorted_heap_online.o src/sorted_vector_hash.o src/svec.o src/hsvec.o src/pq.o src/sorted_hnsw.o src/hnsw_build.o src/flashhadamard.o src/flashhadamard_store.o
PG_CPPFLAGS = -I$(srcdir)/src
DATA = sql/pg_sorted_heap--0.13.0.sql sql/pg_sorted_heap--0.12.0--0.13.0.sql \
       sql/pg_sorted_heap--0.12.0.sql sql/pg_sorted_heap--0.11.0--0.12.0.sql \
       sql/pg_sorted_heap--0.11.0.sql sql/pg_sorted_heap--0.10.0--0.11.0.sql \
       sql/pg_sorted_heap--0.10.0.sql sql/pg_sorted_heap--0.9.15--0.10.0.sql \
       sql/pg_sorted_heap--0.9.15.sql sql/pg_sorted_heap--0.9.14--0.9.15.sql \
       sql/pg_sorted_heap--0.9.14.sql sql/pg_sorted_heap--0.9.13--0.9.14.sql \
       sql/pg_sorted_heap--0.9.13.sql sql/pg_sorted_heap--0.9.12--0.9.13.sql \
...
BENCH_LARGE_VECTOR_PORT ?= 65484
BENCH_LARGE_VECTOR_ROWS ?= 1000
BENCH_LARGE_VECTOR_QUERIES ?= 4
BENCH_LARGE_VECTOR_DIM ?= 64
BENCH_LARGE_VECTOR_K ?= 10
BENCH_LARGE_VECTOR_PGV_STORAGE ?= vector
BENCH_LARGE_VECTOR_PGV_EF_SEARCH ?= 64
