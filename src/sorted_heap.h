...
extern Datum sorted_heap_expand_twohop_rerank(PG_FUNCTION_ARGS);
extern Datum sorted_heap_expand_multihop_rerank(PG_FUNCTION_ARGS);
extern Datum sorted_heap_expand_multihop_path_rerank(PG_FUNCTION_ARGS);
extern Datum sorted_heap_graph_rag_scan(PG_FUNCTION_ARGS);
extern Datum sorted_heap_graph_rag_twohop_scan(PG_FUNCTION_ARGS);
extern Datum sorted_heap_graph_rag_multihop_scan(PG_FUNCTION_ARGS);
extern Datum sorted_heap_graph_rag_multihop_path_scan(PG_FUNCTION_ARGS);
...
extern bool sorted_heap_hnsw_cache_sq8;
extern int  sorted_heap_hnsw_ef_patience;
