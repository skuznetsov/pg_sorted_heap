...
require_path_filter_twice "$LIGHTWORKFLOW" "META.json"
require_path_filter_twice "$LIGHTWORKFLOW" "pg_sorted_heap.control"
require_path_filter_twice "$LIGHTWORKFLOW" "sql/**"
