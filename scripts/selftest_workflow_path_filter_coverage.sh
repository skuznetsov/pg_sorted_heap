...
require_path_filter_twice "$LIGHTWORKFLOW" "scripts/build_graph.py"
require_path_filter_twice "$LIGHTWORKFLOW" "scripts/bench_nomic_local_ann.py"
require_path_filter_twice "$LIGHTWORKFLOW" "scripts/test_graph_builder.sh"
